...
def daily_rapid_kl():
    ...
    combined = pd.concat([daily_rapid_kl, daily_rapid_kl_new, daily_rapid_kl_202512,
                          ...
                          daily_rapid_kl_202604, daily_rapid_kl_202605, daily_rapid_kl_202606], ignore_index=True)
...
def daily_mrt_feeder():
    ...
    combined = pd.concat([daily_mrt_feeder, daily_mrt_feeder_new, daily_mrt_feeder_202512, 
                          ...
                          daily_mrt_feeder_202604, daily_mrt_feeder_202605, daily_mrt_feeder_202606], ignore_index=True)
